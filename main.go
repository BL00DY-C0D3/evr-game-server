...
func main() {
	...
	apiProxy := wrapper.NewAPICachingProxy(HttpPortFlag, PortFlag, lo.ToPtr(30), loggerFlags)
...
func (p *TCPProxy) Start(ctx context.Context, cancel context.CancelFunc, apiCachingProxy *wrapper.APICachingProxy) {
	var err error
